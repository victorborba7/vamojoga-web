      ...
      <div className="p-4 space-y-4">
        ...
        {showForm && (
          <Card className="p-4 space-y-3">
            <p className="text-sm font-semibold text-foreground">Novo collection</p>
            <form onSubmit={handleCreate} className="space-y-3">
              <input
                ...
                placeholder="Nome do collection (ex: Casa dos Silva)"
                value={formName}
        ...
        {loading ? (
          ...
          <p className="text-center text-muted text-sm py-8">
            Você ainda não tem collections compartilhados.
          </p>
        ) : (
